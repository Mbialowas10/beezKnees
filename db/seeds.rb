...
7.times do
  ...
  number_of_beers.times do
    company.beers.create(
      ...
      description: "This #{Faker::Beer.style} style beer has #{Faker::Beer.alcohol} alcohol and was
      brewed with #{Faker::Beer.malts}, #{Faker::Beer.yeast} yest and a twist of #{Faker::Beer.hop} hops.")
  end
end
